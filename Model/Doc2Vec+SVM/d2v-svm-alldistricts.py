...
def doc2vec(X_train,y_train,X_test,y_test,svc_c=0,trial=None,num_epochs=0,alpha=0.015):
  ...
  if trial==None:
    ...
    plt.savefig("/home2/username/legal-tech/doc2vec-ad-svm.png",dpi=300)
    with open("./doc2vec-ad-svm.pkl","wb") as f:
        pickle.dump(clf,f)
    model.save("./doc2vec-ad-svm.model")
...
with open("/home2/username/legal-tech/doc2vec-ad-svm.json","w") as f:
