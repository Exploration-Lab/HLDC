...
def eval_func_epoch(model, dataloader, device, epoch):
    ...
    if epoch == "TESTING":
        ...
        plt.savefig("/home2/username/legal-tech/mt2.png",dpi=300)
...
num_warmup_steps = 0
save_model = True 
model_path = "./mt2.pt" ## Change after every experiment
...
import json
with open("/home2/username/legal-tech/mt2.json","w") as f:
