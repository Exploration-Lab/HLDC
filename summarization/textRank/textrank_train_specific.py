...
import pickle
file = open("path to folder/textRank/model_specific_districts/words_final.pkl",'rb')
corpus = pickle.load(file)
file.close()
print("Corpus Loaded")

from gensim.models import FastText
model = FastText.load('path to folder/textRank/model_specific_districts/model_final.bin')
print("Model Loaded")
...
process("train_split_44_districts.json")
